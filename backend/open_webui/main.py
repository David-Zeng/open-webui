...
async def get_manifest_json():
    ...
    if external_pwa_manifest_url:
        ...
        # Do not alter, remove, obscure, or replace it except as LICENSE permits:
        # https://docs.openwebui.com/license.
        # static/manifest.json is the source of truth for ZR branding (name,
        # colors, icons); name/short_name are overridden here so a WEBUI_NAME
        # env change takes effect without editing the JSON file.
